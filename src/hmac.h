 ...
 *  - sha1_ctx_text: a struct containing all the variables needed in order to execute the sha1 algorithm
 *    on Text, as defined in the HMAC algorithm ( HMAC(Key, Text) ).
 *  - sha1_ctx_key: a struct containing all the variables needed in order to execute the sha1 algorithm
 *    on Key, as defined in the HMAC algorithm ( HMAC(Key, Text) ).
